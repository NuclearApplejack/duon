...
public class Lilith : Interactable {
    ...
    public override void PerformInteraction()
    {
        ...
        {
            generalManager.GetComponent<DialogueManager>().QueueDialogueFile("Dia Main Lab Lilith 2");
        }
        else
        {
            generalManager.GetComponent<DialogueManager>().QueueDialogueFile("Dia Main Lab Lilith 1");
        }
    }
}
